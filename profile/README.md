# Welcome to the Cloaks+ GitHub!

We use GitHub to manage our many repositories for Cloaks+ and all of its services.

To view the source code for our Windows Installer, click [here](https://github.com/CloaksPlus/WindowsInstaller). To downlaod the latest version, go to [our website](https://cloaksplus.com/downloads).
